...
// BOTÃO MENU
// Criando uma constante para o botão
const btnMobile = document.getElementById('btn-mobile');

// Criando a função toggleMenu
function toggleMenu(event) {
  if (event.type === 'touchstart') event.preventDefault();
  const nav = document.getElementById('nav-menu');
  // Adicionando uma classe caso não tenha ou removendo caso tenha (toggle), no nav-menu
...
// Adicionando um evento, evento de clique
